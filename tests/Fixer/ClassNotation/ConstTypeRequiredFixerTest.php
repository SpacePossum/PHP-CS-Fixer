        ...
        yield 'magic constants' => [
            '<?php
                class Foo1
                {
                    ...
                    const string NAMESPACE_1 = __NAMESPACE__;
                    const string CLASS_NAME = __CLASS__;
                    const string TRAIT_REF = __TRAIT__;
            ...
            '<?php
                class Foo1
                {
                    const DIR = __DIR__;
                    const FILE = __FILE__;
                    const NAMESPACE_1 = __NAMESPACE__;
                    const CLASS_NAME = __CLASS__;
                    const TRAIT_REF = __TRAIT__;
        ...
        yield 'already has type' => [
            '<?php
                class Foo
                {
                    ...
                    const iterable|int|string|null|float|bool|mixed|array = 1;
                    const ?X = null;
                }
            '
        ];
